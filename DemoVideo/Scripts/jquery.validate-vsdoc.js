...
$.extend($.fn, {
	...
	validate: function( options ) {
		...
		if (!this.length) {
			options && options.debug && window.loggerConsole && loggerConsole.warn( "nothing selected, can't validate, returning nothing" );
			return;
		}
...
$.extend($.validator, {
	...
	prototype: {
		...
		elements: function() {
			...
			.filter(function() {
				!this.name && validator.settings.debug && window.loggerConsole && loggerConsole.error( "%o has no name assigned", this);
		...
		check: function( element ) {
			...
			for (var method in rules) {
				...
				try {
					...
					this.settings.debug && window.loggerConsole && loggerConsole.log("exception occured when checking element " + element.id
